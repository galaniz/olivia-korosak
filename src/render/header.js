...
const header = (navigations = {}) => {
  ...
  if (navigations?.main) {
    ...
    nav = `
      <nav class="c-nav l-container l-padding-top-2xs l-padding-bottom-2xs l-padding-top-s-m l-padding-bottom-s-m" aria-label="Main">
        ...
        <div class="l-flex l-justify-between l-align-center">
          <a class="c-nav__logo o-logo l-block l-svg" href="${getPermalink()}">
            <span class="a11y-visually-hidden">${enumSite.title} home</span>
            ${logoSvg()}
          </a>
          ${navigations.main}
          <div class="c-nav__hide l-height-l l-width-m">
            <button class="c-nav__button c-nav__open l-height-l l-width-m l-relative l-padding-top-5xs" type="button" aria-haspopup="dialog" aria-controls="" aria-label="Open menu">
          ...
          <div class="c-nav-overflow l-fixed l-right-0 l-bottom-0 l-z-index-1 l-height-100-pc bg-background-light t-dark t-link-current e-transition l-width-4-5" role="dialog" aria-modal="true" aria-label="Main navigation" id="">

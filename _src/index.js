...
import { pageTransition } from '@alanizcreative/formation/src/effects/page-trans'
...
const meta = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        prop: 'navOverflow',
        selector: '.nav-overflow'
      },
      {
        prop: 'navOverflowList',
        selector: '.nav-overflow__list'
      },
      {
        prop: 'navItems',
        selector: '.nav-item[data-depth="0"]',
        all: true
      },
      {
        prop: 'navLinks',
  ...
  },
  {
    ...
    items: [
      ...
      {
        prop: 'audioDuration',
        selector: '.audio-duration'
      },
      {
        prop: 'audioUpdate',
        selector: '.audio-update',
        all: true,
        array: true
      },
      {
        prop: 'audioSlider',
        selector: '.audio-slider'
      },
      {
        prop: 'audioBar',
        selector: '.audio-bar'
      ...
      {
        prop: 'audioScrub',
        selector: '.audio-scrub'
      },
      {
        prop: 'audioClose',
        selector: '.audio-close'
      }
    ]
  }
]
...
const initialize = () => {
  ...
  if (el.nav) {
    const nav = () => {
      const itemSelector = '.nav-item[data-depth="0"]'

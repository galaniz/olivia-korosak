...
const form = ({ args = {}, id }) => {
          ...
          <div class="info-negative bg-diagonal pl-3xs pr-3xs pt-3xs pb-3xs b-radius-s">
            <div class="flex gap-3xs">
              ...
              <div>
                ...
                <ul class="o-form-error__list flex col pb-4xs mb-4xs-all m-0-last text-m-flex lead-base list-none e-underline-all" role="list"></ul>
              </div>
            </div>
          </div>
        </div>
  ...
  const end = `
        ...
        <div data-type="submit">
          <div class="pt-4xs">
            <button class="button b-radius-s e-transition-quad bg-background-light sharp button-l js-submit" type="submit">
              ${loader()}
